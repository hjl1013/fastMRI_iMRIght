...
def parse():
    ...
    parser.add_argument('-p', '--data_path', type=Path, default='/root/input/leaderboard/',
...
if __name__ == '__main__':
    ...
    args.exp_dir = Path('/root/pretrained_models/varnet/brain_leaderboard_state_dict.pt')
    args.forward_dir = '/root/result' / args.net_name / 'reconstructions_forward'
